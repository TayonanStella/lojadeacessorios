    ...
    function dropdownAutoPos() {
        $(document).on('click.dropdown.pos', '.dropdown-toggle[data-position="auto"]', function() {
            ...
            if (parseInt(offset.top + $(this).height()) + 50 >
                (ace.helper.scrollTop() + ace.helper.winHeight() - parent.find('.dropdown-menu').eq(0).height())) parent.addClass('dropup');
...
(function($, undefined) {
    ...
    function Sidebar(sidebar, settings) {
        ...
        this.$sidebar.on(ace.click_event + '.ace.submenu', '.nav-list', function(ev) {
            ...
            if ((minimized && parent_ul == nav_list) ||
...
! function(t, e) {
    "object" == typeof exports && "object" == typeof module ? module.exports = e() : "function" == typeof define && define.amd ? define([], e) : "object" == typeof exports ? exports.GPickr = e() : t.GPickr = e()
}(window, (function() {
    return function(t) {
        var e = {};
        ...
        t.exports = function(t) {
            ...
            function k(t, e, o, n) {
                return e /= 100, o /= 100, [...C(255 * (1 - v(1, (t /= 100) * (1 - (n /= 100)) + n)), 255 * (1 - v(1, e * (1 - n) + n)), 255 * (1 - v(1, o * (1 - n) + n)))]
            }
            ...
            function j(t = 0, e = 0, o = 0, n = 1) {
                const i = (t, e) => (o = -1) => e(~o ? t.map(t => Number(t.toFixed(o))) : t),
                    r = {
                        ...
                        toHEXA() {
                            const t = function(t, e, o) {
                                    return w(t, e, o).map(t => y(t).toString(16).padStart(2, "0"))
                                }(r.h, r.s, r.v),
                        ...
                        _keyboard(t) {
                            ...
                            if (document.activeElement === o.wrapper) {
                                ...
                                if ("keydown" === n && (r || s || c || a)) {
                                    let t = 0,
                                        n = 0;
                                    "v" === o ? t = r || s ? 1 : -1 : "h" === o ? t = r || s ? -1 : 1 : (n = r ? -1 : c ? 1 : 0, t = a ? -1 : s ? 1 : 0), e.update(x(e.cache.x + .01 * t), x(e.cache.y + .01 * n))
                            ...
                            palette: P({
                                ...
                                onchange(o, n) {
                                    ...
                                    for (const e of t._swatchColors) {
                                        ...
                                        t.classList[l === o.toHEXA().toString() ? "add" : "remove"]("pcr-active")
                                    }
                ...
                addSwatch(t) {
                    ...
                    if (e) {
                        const {
                            _swatchColors: t,
                            _root: o
                        } = this, n = j(...e), i = p('<button type="button" style="color: '.concat(n.toRGBA().toString(0), '" aria-label="color swatch"/>'));
            ...
            D.utils = n, D.libs = {
                ...
                Nanopop: E,
                Selectable: L
            }, D.create = t => new D(t), D.version = g.a, e.default = D
        }]).default
        ...
        function* a(t, e, o = -1) {
            for (let n; n = e.exec(t);) yield ~o ? n[o].trim() : n.map(t => t.trim())
        }
        ...
        function u(t) {
            ...
            for (let t = 0; t < n.length; t++) {
                const [e, o, c] = n[t], a = p(o), u = c.split(/\s+/g).map(t => l(t, /^-?(\d*(\.\d+)?)%$/, 1)).filter(Boolean).map(Number);
                if (!u.length && a) i.push({
                    loc: null,
                    color: a
                });
                else if (u.length)
                    for (const t of u) i.push({
                        loc: t,
                        color: a || s
                    });
                else r || (r = e);
        ...
        var h = t => {
            ...
            d = {
                angleToDegrees(t) {
                    const e = t.trim().toLowerCase().match(/^(-?\d*(\.\d+)?)(deg|rad|grad|turn)$/i);
                    if (!e) return null;
                    const o = Number(e[1]);
                    switch (e[3]) {
                        case "deg":
        ...
        class b {
            constructor(t) {
                f(this, "_stops", []), f(this, "_angle", 0), f(this, "_angles", [{
                ...
                }, t), this._root = r(t), CSS.supports("background-image", "conic-gradient(#fff, #fff)") && this._modes.push("conic"), t.el = t.el.split(/>>/g).reduce((t, e, o, n) => (t = t.querySelector(e), o < n.length - 1 ? t.shadowRoot : t), document), t.el.parentElement.replaceChild(this._root.root, t.el), this._pickr = i.a.create({
                    el: this._root.pickr,
                    theme: "nano",
                    inline: !0,
                    useAsButton: !0,
                    ...
                    this._focusedStop && (this._focusedStop.color = t.toRGBA().toString(0), this._render())
                }).on("init", () => {
            ...
            _bindEvents() {
                ...
                g(t.mode, ["mousedown", "touchstart"], t => {
                    ...
                    this._mode = this._modes[e === this._modes.length ? 0 : e], this._render(!0), t.stopPropagation()
                }), g(t.stops.preview, "click", t => {
                    this.addStop(this._pickr.getColor().toRGBA().toString(), this._resolveColorStopPosition(t.pageX))
                    ...
                    const o = g(window, ["mousemove", "touchmove"], e => {
                            const {
                                x: o,
                                y: n
                            } = s(e), i = t.angle.getBoundingClientRect(), r = i.left + i.width / 2, c = i.top + i.height / 2, a = Math.atan2(o - r, n - c) - Math.PI, l = Math.abs(180 * a / Math.PI), p = [1, 2, 4][Number(e.shiftKey || 2 * e.ctrlKey)];
            ...
            _resolveColorStopPosition(t) {
                const {
                    markers: e
                } = this._root.gradient.stops, o = e.getBoundingClientRect();
            ...
            addStop(t, e = .5, o = !1) {
                const {
                    markers: n
                } = this._root.gradient.stops, i = m.createElementFromString('<div class="gpcr-marker"></div>');
                    ...
                    listener: g(i, ["mousedown", "touchstart"], t => {
                        ...
                        const c = g(window, ["mousemove", "touchmove"], t => {
                                const {
                                    x: n,
                                    y: c
                                } = s(t), a = Math.abs(c - e.y);
                                o = a > 50 && this._stops.length > 2, i.style.opacity = o ? "0" : "1", o || (r.loc = this._resolveColorStopPosition(n), this._render())
                            }),
            ...
            removeStop(t) {
                const {
                    _stops: e
                } = this, o = (() => "number" == typeof t ? e.find(t12 => t12.loc === t) : "string" == typeof t ? e.find(t => t.color === t) : "object" == typeof t ? t : void 0)();
                e.splice(e.indexOf(o), 1), o.el.remove(), v(...o.listener), this._focusedStop === o && (this._focusedStop = e[0]), this._render()
            }
            setGradient(t) {
                const e = h(t);
            ...
            getStops() {
                const t = this._stops.map(t => ({
                    ...
                    e = this._mode;
                return t.toString = function(t = e) {
                    switch (t) {
                        case "linear":
                        case "radial":
                            return this.map(t => `${t.color} ${100*t.location}%`).join(",");
                        case "conic":
                            return this.map(t => `${t.color} ${360*t.location}deg`).join(",")
                    }
                }, t
            }
            getLinearAngle() {
            ...
            setLinearAngle(t) {
                return "number" == typeof(t = "number" == typeof t ? t : d.angleToDegrees(t) || (this._angles.find(e => e.name === t) || {}).angle) && (this._angle = t, this._render(), !0)
            }
            setRadialPosition(t) {
                const e = this._directions.find(e => e.css === t);
                if (!e) return !1;
                this._direction = e.css;
                for (const t of Array.from(this._root.gradient.pos.children)) t.classList[t.getAttribute("data-pos") === e.pos ? "add" : "remove"]("gpcr-active");
...
}(jQuery)); /*! jQuery Validation Plugin - v1.19.2 - 5/23/2020 https://jqueryvalidation.org/ Copyright (c) 2020 Jörn Zaefferer; Licensed MIT */
! function(a) {
...
(function($, window, document) {
    ...
    Timepicker.prototype = {
        ...
        getTemplate: function() {
            ...
            templateContent = '<table>' + '<tr>' + '<td><a href="#" data-action="incrementHour"><i class="' + this.iconUp + '"></i></a></td>' + //ACE
                '<td class="separator">&nbsp;</td>' + '<td><a href="#" data-action="incrementMinute"><i class="' + this.iconUp + '"></i></a></td>' + //ACE
                (this.showSeconds ? '<td class="separator">&nbsp;</td>' + '<td><a href="#" data-action="incrementSecond"><i class="' + this.iconUp + '"></i></a></td>' //ACE
                    :
                    '') + (this.showMeridian ? '<td class="separator">&nbsp;</td>' + '<td class="meridian-column"><a href="#" data-action="toggleMeridian"><i class="' + this.iconUp + '"></i></a></td>' //ACE
                    :
                    '') + '</tr>' + '<tr>' + '<td>' + hourTemplate + '</td> ' + '<td class="separator">:</td>' + '<td>' + minuteTemplate + '</td> ' + (this.showSeconds ? '<td class="separator">:</td>' + '<td>' + secondTemplate + '</td>' :
                    '') + (this.showMeridian ? '<td class="separator">&nbsp;</td>' + '<td>' + meridianTemplate + '</td>' :
                    '') + '</tr>' + '<tr>' + '<td><a href="#" data-action="decrementHour"><i class="' + this.iconDown + '"></i></a></td>' + //ACE
                '<td class="separator"></td>' + '<td><a href="#" data-action="decrementMinute"><i class="' + this.iconDown + '"></i></a></td>' + //ACE
                (this.showSeconds ? '<td class="separator">&nbsp;</td>' + '<td><a href="#" data-action="decrementSecond"><i class="' + this.iconDown + '"></i></a></td>' //ACE
                    :
                    '') + (this.showMeridian ? '<td class="separator">&nbsp;</td>' + '<td><a href="#" data-action="toggleMeridian"><i class="' + this.iconDown + '"></i></a></td>' //ACE
                    :
                    '') + '</tr>' + '</table>';
...
(function(global, factory) {
    ...
    function checkOverflow(m) {
        ...
        if (a && getParsingFlags(m).overflow === -2) {
            overflow =
                a[MONTH] < 0 || a[MONTH] > 11 ? MONTH : a[DATE] < 1 || a[DATE] > daysInMonth(a[YEAR], a[MONTH]) ? DATE : a[HOUR] < 0 || a[HOUR] > 24 || (a[HOUR] === 24 && (a[MINUTE] !== 0 || a[SECOND] !== 0 || a[MILLISECOND] !== 0)) ? HOUR : a[MINUTE] < 0 || a[MINUTE] > 59 ? MINUTE : a[SECOND] < 0 || a[SECOND] > 59 ? SECOND : a[MILLISECOND] < 0 || a[MILLISECOND] > 999 ? MILLISECOND : -1;
...
var LanguageModalWidget = function() {
    ...
    _.createContent = function(data, $input) {
        ...
        for (const [key, text] of Object.entries(_.languages)) {
            html += '<li class="languages-modal-item ' + (_.language == key ? 'active' : '') + '" data-id="' + key + '">';
    ...
    _.clickEvent = function(lan) {
        const pageRelativePath = window.location.pathname + window.location.search;
        var full_domain;
        if (lan == 'en') {
            full_domain = 'www.' + _.domain + '.com';
        } else {
            full_domain = lan + '.' + _.domain + '.com';
        }
        if (_.tool == 'website') {
            if (pageRelativePath.includes("support/")) {
                location.href = 'https://' + full_domain + '' + pageRelativePath;
            } else {
                location.href = 'https://' + full_domain + '/manager/websites/include/changeUserCountry.php?changeLan=1';
            }
        } else if (_.tool == 'login') {
            location.href = location.href.split('&').length > 1 ? location.href.replace(/(l=).*?(&)/, '$1' + lan + '$2') :
                location.href.replace(/(l=).*/, '$1' + lan);;
        }
    }
    _.showModal = function(content) {
        _.$bootbox = bootbox.dialog({
                message: content,
                backdrop: true,
                closeButton: true,
                onEscape: true,
    ...
    _.ieh_init = function(settings) {
        ...
        _.$email.on('input', function(event) {
            ...
            $input.typingDelay = setTimeout(function() {
                ...
                if (email != fixedEmail) {
                    _.$emailSuggestion.html(`<b>${_.translations.emailSuggestion}</b> <a href="#" class="suggested-email" style="direction: ltr;">${fixedEmail}</a> ?`);
                }
            }, 300);
        });
    ...
    function tryFixUserEmailMistake(email) {
        ...
        for (var provider in providers) {
            ...
            for (var invalidPatternsKey in invalidPatterns) {
                ...
                if (email.toLowerCase().indexOf(invalidPatterns[invalidPatternsKey]) != -1) {
                    email = email.replace(new RegExp(invalidPatterns[invalidPatternsKey] + '$', 'i'), provider);
                }
            }
        }
        return email;
...
var ShowPassword = function() {
    ...
    _.create = function() {
        const $html = $('<div class="show-password-toggle"><i class="s-p-icon fa fa-eye"></i></div>');
        _.click($html);
